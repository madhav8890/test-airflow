...
RETENTION_MINUTES = 2  # AMI retention period
...
def create_ami():
    ...
    for instance_id in INSTANCE_IDS:
        ...
        ami_name = f"backup-{instance_name}-{datetime.utcnow().strftime('%Y-%m-%d-%H-%M-%S')}"
...
def delete_old_amis():
    ...
    retention_time = datetime.utcnow() - timedelta(minutes=RETENTION_MINUTES)
